...
* `model <- glm(service1 ~ wealthindex, data = data, family = "binomial") `
...
Included _hhid_ and then:

* `model <- gmler(service1 ~ wealthindex + (1|hhid_anon), data = data, family = binomial)`
